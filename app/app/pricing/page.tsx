...
const tiers = [
  {
    ...
    description: "Entry-level access to the model. High-volume 1★ picks across all markets.",
    features: [
      "1★ picks",
  ...
  },
  {
    ...
    description: "Mid-to-high confidence picks plus education to understand the edge behind every bet.",
    features: [
      "1–3★ picks",
      "Real-time Discord alerts",
      "All sports & markets",
  ...
  },
  {
    ...
    description: "Full access. Every pick the model finds, including our highest-confidence 4–5★ plays.",
    features: [
      "All picks — 1★ through 5★",
      "Real-time Discord alerts",
      "All sports & markets",
      "Educational content",
    ],
